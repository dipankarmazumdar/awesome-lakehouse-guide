...
| [Introducing Cloudera Anywhere Cloud](https://community.cloudera.com/t5/Developer-Blogs/Introducing-Cloudera-Anywhere-Cloud-What-it-means-for/ba-p/414543) | `Cloudera Anywhere Cloud`, `Hybrid Cloud`, `AI` | Introduces a modular hybrid data and AI platform that brings a consistent cloud experience to public and sovereign clouds, private data centers, edge, and air-gapped environments while keeping governance and data sovereignty centralized. |
...
| [Building a Multi-Agent Data Quality Workflow inside the Cloudera AI Lakehouse](https://community.cloudera.com/t5/Developer-Blogs/Building-a-Multi-Agent-Data-Quality-Workflow-inside-the/ba-p/414255) | `Apache Iceberg`, `AI Agents`, `Data Quality`, `MCP` | Builds an orchestrated data-quality workflow in which specialized agents execute governed, read-only SQL against Apache Iceberg tables, apply a standardized validation playbook, and produce evidence-backed root-cause reports. |
| [How We Helped Make Apache Iceberg Cool Before the Hype](https://community.cloudera.com/t5/Developer-Blogs/How-we-Helped-make-Apache-Iceberg-Cool-Before-the-Hype/ba-p/413613) | `Apache Iceberg`, `Community` | Reflects on the early work of explaining Iceberg’s open and modular architecture through education, hands-on experiences, technical resources, events, and community programs before open table formats became mainstream. |
| [Building an Open Lakehouse with Apache Iceberg and Apache Ozone](https://community.cloudera.com/t5/Developer-Blogs/Building-an-Open-Lakehouse-with-Apache-Iceberg-and-Apache/ba-p/413422) | `Apache Iceberg`, `Apache Ozone`, `Open Lakehouse` | Explains how Apache Iceberg, an Iceberg REST catalog, Apache Ozone, and compute engines such as Spark can be composed into a modular open lakehouse with S3-compatible storage and ACID table semantics. |
...
| Book | Tags | Quick summary |
| --- | --- | --- |
| [AI Agents in Data Platforms For Dummies](https://www.cloudera.com/campaign/ai-agents-in-data-platforms-for-dummies.html) | `AI Agents`, `Data Platforms`, `Open Lakehouse`, `Apache Iceberg` | Explains how enterprise data platforms can support autonomous agents that discover data, inspect schemas, generate and revise queries, and operate through governed, isolated, and auditable workflows on an open lakehouse foundation. |
